/*******************************************************************************
* RoboCore Kit Iniciante V8 para Arduino - Fazendo Barulho 2
* Aumenta e diminui a frequencia no buzzer de acordo com os botões.
*******************************************************************************/

int frequencia = 1000; // frequencia inicial do buzzer
