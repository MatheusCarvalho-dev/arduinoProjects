...
const char* ssid = "CRISTIANEN";

//Senha da rede
const char* password = "matheus1218";

//IP do ESP (para voce acessar pelo browser - voce TEM que mudar este IP tambem)
IPAddress ip(192, 168, 12, 70); //12 era 43 AND 70 era 50

//IP do roteador da sua rede wifi
IPAddress gateway(192, 168, 12, 1); // 12 era 43
...
void loop() {
  ...
  buf += "</div> ";
  buf += "<div class='col twelve'> ";
  buf += "<p align='center'><font size='5'>by Matheus Carvalho</font></p> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "</body> ";
  buf += "</html> ";
